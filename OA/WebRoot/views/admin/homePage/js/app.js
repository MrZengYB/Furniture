$(function() {
		...
		var fullScreenheight = $("body")[0].clientHeight;
        var $fullText = $('.admin-fullText');
        $('#admin-fullscreen').on('click', function() {
            $.AMUI.fullscreen.toggle();
            if(fullScreenFlag){
            	$(".tpl-left-nav-hover").attr("style", "height:"+ fullScreenheight +"px;overflow:auto;overflow-x:hidden;margin-right:20px;");
            	$(".rightIframe").attr("style", "height:"+ (fullScreenheight - 40) +"px;overflow:hidden;");
            	fullScreenFlag = false;
            } else {
            	var screenHeight = fullScreenheight - 110;
